...
/**
 * DictionaryGimmick - versi dinamis tanpa switch-case
 * Semua gimmick diregistrasi menggunakan Map<String, GimmickAction>
 */
public class DictionaryGimmick {

    /* ==============================
        INTERFACE (core requirement)
    =============================== */
    @FunctionalInterface
    ...
    public DictionaryGimmick(JFrame mainFrame, JPanel headerPanel, JPanel contentPanel, JScrollPane scrollPane) {
        ...
        registerGimmicks();   // <== Gimmick load berbarengan saat inisialisasi (sesuai ketentuan)
    }
    ...
    private void registerGimmicks() {
        ...
        /* ========= Register Semua Warna Dalam Satu Baris ======= */
        registerColor("RED");
        ...
        /* ===== Contoh Gimmick Dengan Parameter ===== */
